...
#         "channel": False,
#         "cancel": False,
#         "hold": 理论被称为兰道尔原理，尽管在科学上仍有争议，但近年来已经得到了一些实验证实。在2019年发表在《美国物理联合会进展》（AIP Advances）杂志上的一项研究中，沃普森假设信息和质量之间可能存在某种联系。这个猜想依赖于著名的质能方程E = mc^2，由阿尔伯特·爱因斯坦在20世纪初推导出来。爱因斯坦的工作表明，能量和质量是可以转换的，这促使沃普森计算出一个比特信息的可能质量——大约比一个电子的质量小1000万倍False,
#         "keyword": True,
#         "white": False,
#         "ot": False,
#         "rm": False,
#         "welcome": False坦的工作表明，能量和质量是可以转换的，这促使沃普森计算出一个比特信息的可能质量——大约比一个电子的质量小1000万倍False,
#         "keyword": True,
#         "white": False,
#         "ot": False,
#         "rm": False,
