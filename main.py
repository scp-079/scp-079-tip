...
from plugins.functions.timers import backup_files, interval_hour_01, interval_min_01, reset_data, send_count
...
scheduler.add_job(interval_hour_01, "interval", [app], hours=10)
